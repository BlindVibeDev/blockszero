              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="flex items-center text-[10px] bg-theme-accent hover:bg-theme-accent-dark text-theme-bg px-2 py-1 rounded transition-colors"
                  >
                    {isAnalyzing ? (
                      <>
              ...
              <div className="mb-3 p-3 bg-theme-accent/5 rounded-lg border border-theme-accent/20">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center text-xs font-medium text-theme-text-primary">
                    <Brain size={12} className="mr-1 text-theme-accent" />
                    AI Analysis
                  </div>
